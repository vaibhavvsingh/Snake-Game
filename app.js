document.addEventListener("DOMContentLoaded", () => {
  ...
  let currentSnake = [2, 1, 0]; //so the din our grid being 2 (or the HEAD), and 0 being the end (TAIL) with all 1's being the body from now on)
  let direction = 1;
  let score = 0;
  let speed = 0.9;
  let intervalTime = 0;
  ...
  //function that deals with all the outcomes of the snakes
  ...
  function randomApple() {
    ...
    } while (squares[appleIndex].classList.contains("snake")); //making sure apples appear outside snake
  ...
  function control(e) {
    ...
    if (e.keyCode === 39) {
      ...
      direction = +width; //if we press up, the snake will instantly appear down one div
    }
  }
